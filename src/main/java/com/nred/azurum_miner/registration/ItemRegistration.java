...
import com.nred.azurum_miner.item.UpgradeItem;
...
public class ItemRegistration {
    ...
    public static final DeferredItem<Item> SIMPLE_UPGRADE = ITEMS.registerItem("simple_upgrade", UpgradeItem::new);
    public static final DeferredItem<Item> UPGRADE = ITEMS.registerItem("upgrade", UpgradeItem::new);
    public static final DeferredItem<Item> ELABORATE_UPGRADE = ITEMS.registerItem("elaborate_upgrade", UpgradeItem::new);
    public static final DeferredItem<Item> COMPLEX_UPGRADE = ITEMS.registerItem("complex_upgrade", UpgradeItem::new);
