...
import com.nred.nredmod.machine.infuser.InfuserScreen.Companion.ENERGY_BAR
import com.nred.nredmod.machine.infuser.InfuserScreen.Companion.ENERGY_INNER
import com.nred.nredmod.machine.infuser.InfuserScreen.Companion.TANK
import com.nred.nredmod.machine.infuser.InfuserScreen.Companion.energy
import com.nred.nredmod.machine.infuser.InfuserScreen.Companion.tank
import com.nred.nredmod.recipe.InfuserRecipe
...
class InfuserCategory(helper: IGuiHelper) : IRecipeCategory<InfuserRecipe> {
    companion object {
        val UID = ResourceLocation.fromNamespaceAndPath(NredMod.ID, "infuser")
    ...
    override fun getTitle(): Component {
        return Component.translatable("menu.title.nredmod.infuser")
    }
