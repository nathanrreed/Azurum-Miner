package com.nred.nredmod

import com.electronwill.nightconfig.core.CommentedConfig
import com.nred.nredmod.block.ModBlocks
import com.nred.nredmod.config.ModCommonConfig
import com.nred.nredmod.config.ModCreativeModTabs
import com.nred.nredmod.config.ModCreativeModTabs.NRED_MOD_TAB
...
object NredMod {
    ...
    init {
        ...
        LOADING_CONTEXT.activeContainer.registerConfig(ModConfig.Type.COMMON, ModCommonConfig.CONFIG_SPEC, "nredmod.toml")
    }

    fun addCreative(event: BuildCreativeModeTabContentsEvent) {
        if (event.getTabKey() == NRED_MOD_TAB.key) {
