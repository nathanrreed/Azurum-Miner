...
import com.nred.nredmod.machine.infuser.InfuserEntity.Companion.get
...
class InfuserScreen(menu: InfuserMenu, playerInventory: Inventory, title: Component) : AbstractContainerScreen<InfuserMenu>(menu, playerInventory, title) {
    ...
    override fun renderBg(guiGraphics: GuiGraphics, partialTick: Float, mouseX: Int, mouseY: Int) {
        ...
        if (tank.containsPoint(mouseX, mouseY)) {
            guiGraphics.renderTooltip(font, Component.translatable("tooltip.nredmod.infuser.info.tank", fluid.fluidType.description, DecimalFormat("#,###").format(fluid.amount)), mouseX, mouseY)
        }
    }
