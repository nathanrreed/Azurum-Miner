...
object ModRecipe {
    val RECIPE_TYPES = DeferredRegister.create(Registries.RECIPE_TYPE, NredMod.ID)
    ...
    val RECIPE_SERIALIZERS = DeferredRegister.create(Registries.RECIPE_SERIALIZER, NredMod.ID)
