...
class ModRecipeProvider(output: PackOutput, registries: CompletableFuture<HolderLookup.Provider>) : RecipeProvider(output, registries), IConditionBuilder {
    ...
    override fun buildRecipes(recipeOutput: RecipeOutput) {
        ...
        LiquifierRecipeBuilder(FluidStack(FLUIDS["molten_ore"].still, 25), Ingredient.of(oreTierTag[0]), 1.0, 50).unlockedBy("has_ore", has(Tags.Items.ORES)).save(recipeOutput, AzurumMiner.ID + ":molten_ore_from_tier1ore")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["molten_ore"].still, 50), Ingredient.of(oreTierTag[1]), 1.0, 35).unlockedBy("has_ore", has(Tags.Items.ORES)).save(recipeOutput, AzurumMiner.ID + ":molten_ore_from_tier2ore")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["molten_ore"].still, 75), Ingredient.of(oreTierTag[2]), 1.0, 30).unlockedBy("has_ore", has(Tags.Items.ORES)).save(recipeOutput, AzurumMiner.ID + ":molten_ore_from_tier3ore")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["molten_ore"].still, 100), Ingredient.of(oreTierTag[3]), 1.0, 25).unlockedBy("has_ore", has(Tags.Items.ORES)).save(recipeOutput, AzurumMiner.ID + ":molten_ore_from_tier4ore")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["molten_ore"].still, 250), Ingredient.of(oreTierTag[4]), 1.0, 20).unlockedBy("has_ore", has(Tags.Items.ORES)).save(recipeOutput, AzurumMiner.ID + ":molten_ore_from_tier5ore")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["nether_essence"].still, 5), Ingredient.of(NETHERRACK, NETHER_BRICK), 1.0, 20).unlockedBy(getHasName(NETHERRACK), has(NETHERRACK)).unlockedBy(getHasName(NETHER_BRICK), has(NETHER_BRICK)).save(recipeOutput, AzurumMiner.ID + ":nether_essence_from_netherrack")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["nether_essence"].still, 20), Ingredient.of(NETHER_BRICKS, NETHER_WART), 1.0, 20).unlockedBy(getHasName(NETHER_BRICKS), has(NETHER_BRICKS)).unlockedBy(getHasName(NETHER_WART), has(NETHER_WART)).save(recipeOutput, AzurumMiner.ID + ":nether_essence_from_nether_bricks")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["nether_essence"].still, 180), Ingredient.of(NETHER_WART_BLOCK), 1.0, 20).unlockedBy(getHasName(NETHER_WART_BLOCK), has(NETHER_WART_BLOCK)).save(recipeOutput, AzurumMiner.ID + ":nether_essence_from_nether_wart_block")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["nether_essence"].still, 250), Ingredient.of(BLAZE_ROD), 1.0, 20).unlockedBy(getHasName(BLAZE_ROD), has(BLAZE_ROD)).save(recipeOutput, AzurumMiner.ID + ":nether_essence_from_nether_blaze_rod")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["nether_essence"].still, 125), Ingredient.of(BLAZE_POWDER), 1.0, 20).unlockedBy(getHasName(BLAZE_POWDER), has(BLAZE_POWDER)).save(recipeOutput, AzurumMiner.ID + ":nether_essence_from_blaze_powder")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["ender_essence"].still, 5), Ingredient.of(END_STONE, END_STONE_BRICKS), 1.0, 20).unlockedBy(getHasName(END_STONE), has(END_STONE)).unlockedBy(getHasName(END_STONE_BRICKS), has(END_STONE_BRICKS)).save(recipeOutput, AzurumMiner.ID + ":ender_essence_from_end_stone")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["ender_essence"].still, 50), Ingredient.of(END_ROD, ENDER_PEARL), 1.0, 20).unlockedBy(getHasName(END_ROD), has(END_ROD)).unlockedBy(getHasName(ENDER_PEARL), has(ENDER_PEARL)).save(recipeOutput, AzurumMiner.ID + ":ender_essence_from_end_rod")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["ender_essence"].still, 150), Ingredient.of(ENDER_EYE), 1.0, 20).unlockedBy(getHasName(ENDER_EYE), has(ENDER_EYE)).save(recipeOutput, AzurumMiner.ID + ":ender_essence_from_ender_eye")
        LiquifierRecipeBuilder(FluidStack(FLUIDS["ender_essence"].still, 1000), Ingredient.of(END_CRYSTAL), 1.0, 20).unlockedBy(getHasName(END_CRYSTAL), has(END_CRYSTAL)).save(recipeOutput, AzurumMiner.ID + ":ender_essence_from_end_crystal")
        LiquifierRecipeBuilder(FluidStack(snow_still, 40), Ingredient.of(SNOW_BLOCK), 1.0, 40).unlockedBy(getHasName(SNOW_BLOCK), has(SNOW_BLOCK)).save(recipeOutput, AzurumMiner.ID + ":powdered_snow_from_snow")
        LiquifierRecipeBuilder(FluidStack(snow_still, 10), Ingredient.of(SNOWBALL), 1.0, 20).unlockedBy(getHasName(SNOWBALL), has(SNOWBALL)).save(recipeOutput, AzurumMiner.ID + ":powdered_snow_from_snow_ball")

        LiquifierRecipeBuilder(FluidStack(FLUIDS["diamond_crystal_solution"].still, 750), Ingredient.of(DIAMOND), FluidStack(Fluids.WATER, 5000), 40.0, 400).unlockedBy(getHasName(DIAMOND), has(DIAMOND)).save(recipeOutput)
        LiquifierRecipeBuilder(FluidStack(FLUIDS["emerald_crystal_solution"].still, 750), Ingredient.of(EMERALD), FluidStack(Fluids.WATER, 5000), 50.0, 500).unlockedBy(getHasName(EMERALD), has(EMERALD)).save(recipeOutput)
        LiquifierRecipeBuilder(FluidStack(FLUIDS["quartz_crystal_solution"].still, 500), Ingredient.of(QUARTZ), FluidStack(Fluids.WATER, 2000), 30.0, 200).unlockedBy(getHasName(QUARTZ), has(QUARTZ)).save(recipeOutput)
        LiquifierRecipeBuilder(FluidStack(FLUIDS["amethyst_crystal_solution"].still, 500), Ingredient.of(AMETHYST_SHARD), FluidStack(Fluids.WATER, 3000), 20.0, 200).unlockedBy(getHasName(AMETHYST_SHARD), has(AMETHYST_SHARD)).save(recipeOutput)
        LiquifierRecipeBuilder(FluidStack(FLUIDS["prismarine_crystal_solution"].still, 500), Ingredient.of(PRISMARINE_CRYSTALS), FluidStack(Fluids.WATER, 3000), 40.0, 200).unlockedBy(getHasName(PRISMARINE_CRYSTALS), has(PRISMARINE_CRYSTALS)).save(recipeOutput)

        InfuserRecipeBuilder(ItemStack(ORES["azurum"].ingot!!.asItem(), 1), Ingredient.of(ORES["azurum"].gem), Ingredient.of(IRON_INGOT), FluidStack(Fluids.LAVA, 1000), 1.0, 200).save(recipeOutput, AzurumMiner.ID + ":azurum_ingot_from_infuser")
        InfuserRecipeBuilder(ItemStack(OBSIDIAN, 1), Ingredient.of(ICE), Ingredient.EMPTY, FluidStack(Fluids.LAVA, 1000), 1.0, 200).save(recipeOutput, AzurumMiner.ID + ":obsidian_from_infuser")
        InfuserRecipeBuilder(ItemStack(OBSIDIAN, 9), Ingredient.of(ICE), Ingredient.of(BLUE_ICE), FluidStack(Fluids.LAVA, 1000), 2.0, 600).save(recipeOutput, AzurumMiner.ID + ":multi_obsidian_from_infuser")

        InfuserRecipeBuilder(ItemStack(NETHER_DIAMOND.asItem(), 1), Ingredient.of(BLAZE_POWDER), Ingredient.of(DIAMOND), FluidStack(FLUIDS["nether_essence"].still.get(), 1000), 1.0, 200).save(recipeOutput)
        InfuserRecipeBuilder(ItemStack(ENDER_DIAMOND.asItem(), 1), Ingredient.of(ENDER_PEARL), Ingredient.of(DIAMOND), FluidStack(FLUIDS["ender_essence"].still.get(), 1000), 1.0, 200).save(recipeOutput)
        InfuserRecipeBuilder(ItemStack(ENDER_EYE, 1), Ingredient.of(ENDER_PEARL), Ingredient.EMPTY, FluidStack(FLUIDS["nether_essence"].still.get(), 500), 1.0, 200).save(recipeOutput, AzurumMiner.ID + ":ender_eye_from_infuser")
        InfuserRecipeBuilder(ItemStack(END_STONE, 1), Ingredient.of(STONE), Ingredient.EMPTY, FluidStack(FLUIDS["ender_essence"].still.get(), 250), 1.0, 20).save(recipeOutput, AzurumMiner.ID + ":end_stone_from_infuser")
        InfuserRecipeBuilder(ItemStack(END_STONE_BRICKS, 1), Ingredient.of(STONE_BRICKS), Ingredient.EMPTY, FluidStack(FLUIDS["ender_essence"].still.get(), 250), 1.0, 20).save(recipeOutput, AzurumMiner.ID + ":end_stone_bricks_from_infuser")
        InfuserRecipeBuilder(ItemStack(NETHERRACK, 1), Ingredient.of(COBBLESTONE), Ingredient.EMPTY, FluidStack(FLUIDS["nether_essence"].still.get(), 50), 1.0, 20).save(recipeOutput, AzurumMiner.ID + ":netherrack_from_infuser")
        InfuserRecipeBuilder(ItemStack(SOUL_SAND, 1), Ingredient.of(SAND), Ingredient.EMPTY, FluidStack(FLUIDS["nether_essence"].still.get(), 150), 1.0, 20).save(recipeOutput, AzurumMiner.ID + ":soul_sand_from_infuser")
        InfuserRecipeBuilder(ItemStack(SOUL_SOIL, 1), Ingredient.of(RED_SAND), Ingredient.EMPTY, FluidStack(FLUIDS["nether_essence"].still.get(), 150), 1.0, 20).save(recipeOutput, AzurumMiner.ID + ":soul_soil_from_infuser")
        InfuserRecipeBuilder(ItemStack(MAGMA_BLOCK, 1), Ingredient.of(DEEPSLATE), Ingredient.EMPTY, FluidStack(FLUIDS["nether_essence"].still.get(), 1000), 1.0, 60).save(recipeOutput, AzurumMiner.ID + ":magma_block_from_infuser")
        InfuserRecipeBuilder(ItemStack(SOUL_TORCH, 1), Ingredient.of(TORCH), Ingredient.EMPTY, FluidStack(FLUIDS["nether_essence"].still.get(), 200), 1.0, 40).save(recipeOutput, AzurumMiner.ID + ":soul_torch_from_infuser")
        InfuserRecipeBuilder(ItemStack(SOUL_LANTERN, 1), Ingredient.of(LANTERN), Ingredient.EMPTY, FluidStack(FLUIDS["nether_essence"].still.get(), 200), 1.0, 40).save(recipeOutput, AzurumMiner.ID + ":soul_lantern_from_infuser")
        InfuserRecipeBuilder(ItemStack(SOUL_CAMPFIRE, 1), Ingredient.of(CAMPFIRE), Ingredient.EMPTY, FluidStack(FLUIDS["nether_essence"].still.get(), 200), 1.0, 40).save(recipeOutput, AzurumMiner.ID + ":soul_campfire_from_infuser")
        InfuserRecipeBuilder(ItemStack(CONGLOMERATE_OF_ORE.asItem(), 1), Ingredient.of(ORES["azurum"].nugget), Ingredient.of(STONE), FluidStack(FLUIDS["molten_ore"].still.get(), 1000), 1.0, 200).save(recipeOutput)

        InfuserRecipeBuilder(ItemStack(BLUE_ICE.asItem(), 1), Ingredient.of(PACKED_ICE), Ingredient.EMPTY, FluidStack(snow_still, 1000), 10.0, 2000).save(recipeOutput)
        InfuserRecipeBuilder(ItemStack(PACKED_ICE.asItem(), 1), Ingredient.of(ICE), Ingredient.EMPTY, FluidStack(snow_still, 1000), 10.0, 2000).save(recipeOutput)
        InfuserRecipeBuilder(ItemStack(ICE.asItem(), 1), Ingredient.of(SNOW_BLOCK), Ingredient.EMPTY, FluidStack(snow_still, 1000), 10.0, 2000).save(recipeOutput)

        TransmogrifierRecipeBuilder(ItemStack(RED_SAND, 1), Ingredient.of(SAND), 1.0, 60).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(CALCITE, 1), Ingredient.of(DIORITE), 1.0, 60).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(TUFF, 1), Ingredient.of(ANDESITE), 1.0, 60).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(BASALT, 1), Ingredient.of(DEEPSLATE), 2.0, 180).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(GILDED_BLACKSTONE, 1), Ingredient.of(BLACKSTONE), 2.0, 1200).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(PACKED_MUD, 1), Ingredient.of(GRANITE), 1.6, 120).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(SPONGE, 1), Ingredient.of(STRIPPED_BAMBOO_BLOCK), 10.0, 2400).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(BUDDING_AMETHYST, 1), Ingredient.of(ItemStack(AMETHYST_BLOCK, 8)), 1.0, 2400).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(DEAD_BUSH, 1), Ingredient.of(SAPLINGS), 2.0, 60).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(OXIDIZED_COPPER, 1), Ingredient.of(COPPER_BLOCK), 2.0, 360).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(CRYING_OBSIDIAN, 1), Ingredient.of(OBSIDIAN), 20.0, 3600).save(recipeOutput)
        TransmogrifierRecipeBuilder(ItemStack(CONGLOMERATE_OF_ORE_SHARD.get(), 2), Ingredient.of(CONGLOMERATE_OF_ORE), 40.0, 1200).save(recipeOutput, AzurumMiner.ID + ":conglomerate_of_ore_shard_from_ore")

        CrystallizerRecipeBuilder(ItemStack(DIAMOND, 1), Ingredient.of(SEED_CRYSTAL.get()), 0.5f, FluidStack(FLUIDS["diamond_crystal_solution"].still.get(), 500), 4.0, 600).save(recipeOutput)
        CrystallizerRecipeBuilder(ItemStack(EMERALD, 1), Ingredient.of(SEED_CRYSTAL.get()), 0.5f, FluidStack(FLUIDS["emerald_crystal_solution"].still.get(), 500), 4.5, 800).save(recipeOutput)
        CrystallizerRecipeBuilder(ItemStack(QUARTZ, 2), Ingredient.of(SEED_CRYSTAL.get()), 0.5f, FluidStack(FLUIDS["quartz_crystal_solution"].still.get(), 150), 1.0, 60).save(recipeOutput)
        CrystallizerRecipeBuilder(ItemStack(AMETHYST_SHARD, 1), Ingredient.of(SEED_CRYSTAL.get()), 0.5f, FluidStack(FLUIDS["amethyst_crystal_solution"].still.get(), 150), 1.5, 200).save(recipeOutput)
        CrystallizerRecipeBuilder(ItemStack(PRISMARINE_CRYSTALS, 2), Ingredient.of(SEED_CRYSTAL.get()), 0.5f, FluidStack(FLUIDS["prismarine_crystal_solution"].still.get(), 150), 2.0, 300).save(recipeOutput)
        CrystallizerRecipeBuilder(ItemStack(END_CRYSTAL, 1), Ingredient.of(DIAMOND), 1f, FluidStack(FLUIDS["ender_essence"].still.get(), 5000), 8.5, 1200).save(recipeOutput)
        CrystallizerRecipeBuilder(ItemStack(VOID_CRYSTAL.get(), 1), Ingredient.of(ENERGY_SHARD), 1f, FluidStack(FLUIDS["ender_essence"].still.get(), 3000), 2.0, 600).save(recipeOutput)
        CrystallizerRecipeBuilder(ItemStack(ENERGY_SHARD.get(), 1), Ingredient.of(ORES["azurum"].gem), 1f, FluidStack(Fluids.LAVA, 4000), 1.0 / 6.0, 600).save(recipeOutput)
