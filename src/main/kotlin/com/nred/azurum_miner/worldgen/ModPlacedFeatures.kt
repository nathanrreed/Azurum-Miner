...
//    }
    ...
    fun bootstrap(context: BootstrapContext<PlacedFeature>) {
        ...
        register(context, AZURUM_ORE_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.AZURUM_ORE_KEY), rareOrePlacement(2, HeightRangePlacement.triangle(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(4))))
    }
