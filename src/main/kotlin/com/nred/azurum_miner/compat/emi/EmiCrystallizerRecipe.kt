...
class EmiCrystallizerRecipe(val recipeId: ResourceLocation, inputs: List<EmiIngredient>, val output: EmiStack, val power: Int, val processingTime: Int) : BasicEmiRecipe(INFUSER_CATEGORY, recipeId, 120, 69) {
    init {
