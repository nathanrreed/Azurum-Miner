...
class CrystallizerRecipe(val inputItem: Ingredient, val inputFluid: FluidStack, val result: ItemStack, val fluidResult: FluidStack, val power: Int, val processingTime: Int) : Recipe<CrystallizerInput> {
    ...
    companion object {
        val CODEC: MapCodec<CrystallizerRecipe> = RecordCodecBuilder.mapCodec { inst ->
            inst.group(
                ...
                FluidStack.CODEC.fieldOf("fluidResult").forGetter(CrystallizerRecipe::fluidResult),
        ...
        val STREAM_CODEC: StreamCodec<RegistryFriendlyByteBuf, CrystallizerRecipe> = StreamCodec.composite(
            ...
            FluidStack.STREAM_CODEC, CrystallizerRecipe::fluidResult,
...
class CrystallizerRecipeBuilder(result: ItemStack, fluidResult: FluidStack, private val inputItem: Ingredient, private val inputFluid: FluidStack, private val power: Int, private val processingTime: Int) : SimpleItemFluidRecipeBuilder(result, fluidResult) {
    override fun save(output: RecipeOutput, key: ResourceLocation) {
        ...
        val recipe = CrystallizerRecipe(this.inputItem, this.inputFluid, this.result, this.fluidResult, this.power, this.processingTime)
