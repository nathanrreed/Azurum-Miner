...
class CrystallizerRecipeBuilder(result: ItemStack, private val inputItem: Ingredient, private val inputFluid: FluidStack, private val power: Int, private val processingTime: Int) : SimpleRecipeBuilder(result) {
    override fun save(output: RecipeOutput, key: ResourceLocation) {
        ...
        val recipe = CrystallizerRecipe(this.inputItem, this.inputFluid, this.result, this.power, this.processingTime)
